...
def discrete_simulation(b, k, N = 1000, T = 100, z = 1):
    """
...
def main_discrete(b, k, N = 1000, T = 100, z = 1):
    ...
    # Runs simulation
    c_inf, c_sus, c_rem = discrete_simulation(b, k, N, T, z)
